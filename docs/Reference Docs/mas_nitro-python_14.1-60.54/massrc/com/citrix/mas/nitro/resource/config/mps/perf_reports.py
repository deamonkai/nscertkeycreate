...
class perf_reports(base_resource):
	...
	'''
	get Type of entity (global/lbvserver/service/servicegroup/csvserver/crvserver/authenticationvserver/vpnvserver/gslbvserver)
	'''
	@property
	def entity_type(self) :
		try:
			...
			raise e
	'''
	set Type of entity (global/lbvserver/service/servicegroup/csvserver/crvserver/authenticationvserver/vpnvserver/gslbvserver)
	'''
	@entity_type.setter
