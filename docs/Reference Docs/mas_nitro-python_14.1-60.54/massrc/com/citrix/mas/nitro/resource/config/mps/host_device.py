...
class host_device(managed_device):
	...
	_disk_usage= ""
	_enabled= ""
	_number_of_cpu_cores= ""
	_disk_free= ""
	_scu_free= ""
	_total_crypto_devices= ""
	_scu_total= ""
	_memory_total= ""
	_uuid= ""
	_cpu_usage= ""
	...
	'''
	get Number of total CPU cores of host
	'''
	@property
	def number_of_cpu_cores(self) :
		try:
			return self._number_of_cpu_cores
		except Exception as e :
			raise e
	...
	'''
	get Free Symmetric Crypto Units
	'''
	@property
	def scu_free(self) :
		try:
			return self._scu_free
		except Exception as e :
			raise e


	'''
	get Total Crypto Devices
	'''
	@property
	def total_crypto_devices(self) :
		try:
			return self._total_crypto_devices
		except Exception as e :
			raise e


	'''
	get Total Symmetric Crypto Units available in host
	'''
	@property
	def scu_total(self) :
		try:
			return self._scu_total
		except Exception as e :
			raise e
	...
	'''
	get Total Asymmetric Crypto Units available in host
	'''
	@property
	def acu_total(self) :
		try:
			return self._acu_total
		except Exception as e :
			raise e


	'''
	get Free Asymmetric Crypto Units
	'''
	@property
	def acu_free(self) :
		try:
			return self._acu_free
		except Exception as e :
			raise e
