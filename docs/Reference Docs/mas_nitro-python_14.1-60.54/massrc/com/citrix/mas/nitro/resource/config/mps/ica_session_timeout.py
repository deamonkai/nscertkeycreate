...
class ica_session_timeout(base_resource):
	...
	'''
	get Gateway session timeout value
	'''
	@property
	def gateway_session_timeout(self) :
		try:
			return self._gateway_session_timeout
		except Exception as e :
			raise e
	'''
	set Gateway session timeout value
	'''
	@gateway_session_timeout.setter
	def gateway_session_timeout(self,gateway_session_timeout):
		try :
			if not isinstance(gateway_session_timeout,int):
				raise TypeError("gateway_session_timeout must be set to int value")
			self._gateway_session_timeout = gateway_session_timeout
		except Exception as e :
			raise e

	'''
	To set the ica/gateway session timeout.
	'''
	@classmethod
	...
	'''
	To get the ica/gateway session timeout.
	'''
	@classmethod
