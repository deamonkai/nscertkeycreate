...
class cipher_group(base_resource):
	...
	'''
	get Describing the Cipher Group algorithms created
	'''
	@property
	def cipher_group_description(self) :
		try:
			...
			raise e
	'''
	set Describing the Cipher Group algorithms created
	'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				cipher_group_obj= cipher_group()
				return cls.perform_operation_bulk_request(service,resource,cipher_group_obj)
		except Exception as e :
			raise e
