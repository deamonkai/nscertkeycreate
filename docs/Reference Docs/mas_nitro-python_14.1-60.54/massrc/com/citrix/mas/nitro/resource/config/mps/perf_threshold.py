...
'''
Configuration for Network Reporting Threshold resource
'''
...
class perf_threshold(base_resource):
	...
	'''
	get Entitles like vserver, service or servicegroup with instance display names
	'''
	@property
	def entities(self) :
		try:
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				perf_threshold_obj= perf_threshold()
				return cls.perform_operation_bulk_request(service,resource,perf_threshold_obj)
		except Exception as e :
			raise e
