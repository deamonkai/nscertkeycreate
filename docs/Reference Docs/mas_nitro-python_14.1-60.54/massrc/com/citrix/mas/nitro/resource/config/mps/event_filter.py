...
class event_filter(base_resource):
	...
	'''
	get Event Age Threshold - Specify the time interval for which the event has to be in the same state to trigger the action
	'''
	@property
	def event_age_threshold(self) :
		try:
			...
			raise e
	'''
	set Event Age Threshold - Specify the time interval for which the event has to be in the same state to trigger the action
	'''
	...
	'''
	get Display the event even when event age threshold is set.
	'''
	@property
	def display_event(self) :
		try:
			return self._display_event
		except Exception as e :
			raise e
	'''
	set Display the event even when event age threshold is set.
	'''
	@display_event.setter
	def display_event(self,display_event):
		try :
			if not isinstance(display_event,bool):
				raise TypeError("display_event must be set to bool value")
			self._display_event = display_event
		except Exception as e :
			raise e
	...
	'''
	get Enable Advanced regex for Failure Objects, Message and configuration command
	'''
	@property
	def enable_advanced_regex(self) :
		try:
			return self._enable_advanced_regex
		except Exception as e :
			raise e
	'''
	set Enable Advanced regex for Failure Objects, Message and configuration command
	'''
	@enable_advanced_regex.setter
	def enable_advanced_regex(self,enable_advanced_regex):
		try :
			if not isinstance(enable_advanced_regex,bool):
				raise TypeError("enable_advanced_regex must be set to bool value")
			self._enable_advanced_regex = enable_advanced_regex
		except Exception as e :
			raise e
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				event_filter_obj= event_filter()
				return cls.perform_operation_bulk_request(service,resource,event_filter_obj)
		except Exception as e :
			raise e
