...
class rba_operation_client_data(base_resource):
	...
	'''
	get This describes the comma separated resources, permission for which is dependent on this resource type
	'''
	@property
	...
	'''
	get This describes the operation display name under a particular tree node
	'''
	@property
	...
	'''
	get This describes the resource for a particular tree node
	'''
	@property
	...
	'''
	get This describes the operation type for a particular tree node
	'''
	@property
	def type(self) :
		try:
	...
	'''
	get This describes the operation name under a particular tree node
	'''
	@property
