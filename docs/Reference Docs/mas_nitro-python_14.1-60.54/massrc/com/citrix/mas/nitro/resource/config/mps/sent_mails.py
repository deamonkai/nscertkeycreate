...
class sent_mails(base_resource):
	...
	def sender_username(self,sender_username):
		try :
			if not isinstance(sender_username,str):
				raise TypeError("sender_username must be set to str value")
	...
	'''
	@property
	def bcc_list_enc(self) :
		try:
			return self._bcc_list_enc
		except Exception as e :
			raise e
	'''
	set List to whom BCC the mail.
	'''
	@bcc_list_enc.setter
	def bcc_list_enc(self,bcc_list_enc):
		try :
			if not isinstance(bcc_list_enc,str):
				raise TypeError("bcc_list_enc must be set to str value")
			self._bcc_list_enc = bcc_list_enc
		except Exception as e :
			raise e
	...
	'''
	@property
	def to_list_enc(self) :
		try:
			return self._to_list_enc
		except Exception as e :
			raise e
	'''
	set List of to whom send the mail. 
	'''
	@to_list_enc.setter
	def to_list_enc(self,to_list_enc):
		try :
			if not isinstance(to_list_enc,str):
				raise TypeError("to_list_enc must be set to str value")
			self._to_list_enc = to_list_enc
		except Exception as e :
			raise e
	...
	'''
	@property
	def cc_list_enc(self) :
		try:
			return self._cc_list_enc
		except Exception as e :
			raise e
	'''
	set List to whom CC the mail.
	'''
	@cc_list_enc.setter
	def cc_list_enc(self,cc_list_enc):
		try :
			if not isinstance(cc_list_enc,str):
				raise TypeError("cc_list_enc must be set to str value")
			self._cc_list_enc = cc_list_enc
		except Exception as e :
			raise e
