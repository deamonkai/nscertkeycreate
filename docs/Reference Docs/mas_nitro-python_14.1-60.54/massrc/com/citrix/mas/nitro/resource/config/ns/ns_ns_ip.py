...
'''
Configuration for IP on NetScaler resource
'''
...
class ns_ns_ip(base_resource):
	...
	'''
	get mgmtaccess ENABLED/DISABLED
	'''
	@property
	def mgmtaccess(self) :
		try:
			...
			raise e
	'''
	set mgmtaccess ENABLED/DISABLED
	'''
	@mgmtaccess.setter
	def mgmtaccess(self,mgmtaccess):
		try :
			if not isinstance(mgmtaccess,str):
				raise TypeError("mgmtaccess must be set to str value")
	...
	'''
	get NetScaler ipaddress that needs to be created
	'''
	@property
	def ipaddress(self) :
		try:
			...
			raise e
	'''
	set NetScaler ipaddress that needs to be created
	'''
	@ipaddress.setter
	...
	'''
	get NetScaler IP Address where IP needs to be created
	'''
	@property
	def ns_ip_address(self) :
		try:
			...
			raise e
	'''
	set NetScaler IP Address where IP needs to be created
	'''
	...
	'''
	get Type of IP Address, Possible Values: SNIP, NSIP, VIP
	'''
	@property
	def type(self) :
		try:
			...
			raise e
	'''
	set Type of IP Address, Possible Values: SNIP, NSIP, VIP
	'''
	@type.setter
	def type(self,type):
		try :
	...
	'''
	Use this operation to add ns ip on NetScaler Instance.
	'''
	@classmethod
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				return cls.perform_operation_bulk_request(service,resource,ns_ns_ip_obj)
		except Exception as e :
			raise e
