...
class configuration_template(base_resource):
	...
	'''
	get Family of Devices i.e. ns, sdx for which config template is defined.
	'''
	@property
	def device_family(self) :
		try:
			...
			raise e
	'''
	set Family of Devices i.e. ns, sdx for which config template is defined.
	'''
	...
	'''
	get Parent name of configuration template
	'''
	@property
	def parent_name(self) :
		try:
			...
			raise e
	'''
	set Parent name of configuration template
	'''
	@parent_name.setter
	...
	'''
	get Parent Id of configuration template
	'''
	@property
	def parent_id(self) :
		try:
			...
			raise e
	'''
	set Parent Id of configuration template
	'''
	@parent_id.setter
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				configuration_template_obj= configuration_template()
				return cls.perform_operation_bulk_request(service,resource,configuration_template_obj)
		except Exception as e :
			raise e
