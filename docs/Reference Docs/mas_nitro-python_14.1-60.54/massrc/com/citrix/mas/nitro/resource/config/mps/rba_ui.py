...
class rba_ui(base_resource):
	...
	'''
	get Display name for UI tree node
	'''
	@property
	def display_name(self) :
		try:
			...
			raise e
	'''
	set Display name for UI tree node
	'''
	@display_name.setter
	...
	'''
	get Unique name for UI tree node
	'''
	@property
	def name(self) :
		try:
			...
			raise e
	'''
	set Unique name for UI tree node
	'''
	@name.setter
	def name(self,name):
		try :
	...
	'''
	Use this operation to get all UI tress nodes are authorized to a user..
	'''
	@classmethod
