...
from massrc.com.citrix.mas.nitro.resource.config.ns.ns_services import ns_services

'''
Configuration for NetScaler GSLB Services Information resource
'''

class ns_gslbservice(ns_services):
	__count=""
	'''
	get the resource id
	'''
	...
	def get_object_id(self) :
		try:
			return super(ns_gslbservice,self).get_object_id()
		except Exception as e :
			raise e
	...
	'''
	Use this operation to poll the GSLB Service.
	'''
	@classmethod
