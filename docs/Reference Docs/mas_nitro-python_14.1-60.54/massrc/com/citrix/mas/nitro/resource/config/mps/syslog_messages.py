...
class syslog_messages(base_resource):
	...
	set User Name
	'''
	@user_name_enc.setter
	def user_name_enc(self,user_name_enc):
		try :
			if not isinstance(user_name_enc,str):
				raise TypeError("user_name_enc must be set to str value")
			self._user_name_enc = user_name_enc
		except Exception as e :
			raise e
	...
	def user_id(self,user_id):
		try :
			if not isinstance(user_id,str):
				raise TypeError("user_id must be set to str value")
