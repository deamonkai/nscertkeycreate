...
class filter_criteria(base_resource):
	...
	'''
	get Source Ip Address of the device which sent the trap
	'''
	@property
	def source(self) :
		try:
			...
			raise e
	'''
	set Source Ip Address of the device which sent the trap
	'''
	@source.setter
	...
	def failureobj(self) :
		try:
			...
			raise e
	'''
	set Failure objects are entity instances or counters for which an event has been generated
	'''
	@failureobj.setter
	...
	def config_cmd(self) :
		try:
			...
			raise e
	'''
	set Config Command if the event is generated for any config change in device
	'''
	@config_cmd.setter
	...
	def cmd_auth_status(self) :
		try:
			...
			raise e
	'''
	set Command Authorization Status if the event is generated for any config change or config save in device
	'''
	...
	def device_family(self) :
		try:
			...
			raise e
	'''
	set Family of device for which we have received the event
	'''
	...
	def cmd_exec_status(self) :
		try:
			...
			raise e
	'''
	set Command Execution Status if the event is generated for any config change or config save in device
	'''
	...
	'''
	get Name of the parent resource
	'''
	@property
	def parent_name(self) :
		try:
			...
			raise e
	'''
	set Name of the parent resource
	'''
	@parent_name.setter
