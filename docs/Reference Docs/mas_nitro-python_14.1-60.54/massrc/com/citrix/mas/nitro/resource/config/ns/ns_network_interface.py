...
class ns_network_interface(base_resource):
	...
	'''
	Number of error free outgoing packets discarded
	'''
	@property
	...
	Number of error free outgoing packets discarded
	'''
	@nicerrifoutdiscards.setter
	def nicerrifoutdiscards(self,nicerrifoutdiscards):
		try :
			if not isinstance(nicerrifoutdiscards,float):
				raise TypeError("nicerrifoutdiscards must be set to float value")
			self._nicerrifoutdiscards = nicerrifoutdiscards
		except Exception as e :
			raise e
	...
	'''
	Number of error free incoming packets discarded
	'''
	@property
	...
	Number of error free incoming packets discarded
	'''
	@errifindiscards.setter
	def errifindiscards(self,errifindiscards):
		try :
			if not isinstance(errifindiscards,float):
				raise TypeError("errifindiscards must be set to float value")
			self._errifindiscards = errifindiscards
		except Exception as e :
			raise e
