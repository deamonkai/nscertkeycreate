...
class filter_scheduler(base_resource):
	...
	'''
	get Type of recurrence of schedule for the filter : daily/weekly/specific day
	'''
	@property
	def recurrence_type(self) :
		try:
			...
			raise e
	'''
	set Type of recurrence of schedule for the filter : daily/weekly/specific day
	'''
	...
	'''
	get filter status - enabled, disabled, pause
	'''
	@property
	def filter_status(self) :
		try:
			...
			raise e
	'''
	set filter status - enabled, disabled, pause
	'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				filter_scheduler_obj= filter_scheduler()
				return cls.perform_operation_bulk_request(service,resource,filter_scheduler_obj)
		except Exception as e :
			raise e
