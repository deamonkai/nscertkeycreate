...
class options(object):
    ...
    def __init__(self):
        ...
        self._args = ""
        self._duration=""
        self._duration_summary = 0
        self._queryparams_map = {}
    ...
    '''
    sets the _duration_summary to be performed.
    @param _duration_summary
    '''
    ...
    * @param flag
    ...
    '''
    sets _attrs field.
    @param _attrs optional _attrs required for any operation. self is in json format.
    '''
    @attrs.setter
    ...
    '''
    @return returns _queryparams_map
    '''
    @property
    def queryparams_map(self):
        return self._queryparams_map

    '''
    sets _queryparams_map field.
    @param _queryparams_map set self with the _queryparams_map map to pass additional query parameters.
    '''
    @queryparams_map.setter
    def queryparams_map(self, qp_map):
        try :
            if not isinstance(qp_map ,dict):
                raise TypeError("queryparams map must be set to dictionary")
            self._queryparams_map = qp_map.copy()
        except Exception as e :
            raise e

    '''
    Adds an entry into the _queryparams_map
    @param _queryparams_map set self with the _queryparams_map map to pass additional query parameters.
    '''
    def add_queryparam(self, queryparam, value):
        self._queryparams_map[queryparam] = value 
    ...
    def to_string(self):
        try:
            ...
            if self._attrs :
                if options_str :
                    options_str = options_str + "&"
                options_str = options_str+"attrs="+self._attrs
            ...
            if self._duration_summary >= 0 :
                if options_str :
                    options_str = options_str + "&"
                options_str = options_str +"duration_summary="+str(self._duration_summary)
            ...
            for item in self._queryparams_map :
                if options_str : 
                    options_str = options_str + "&"
                options_str = options_str + item + "=" + self._queryparams_map[item] 
