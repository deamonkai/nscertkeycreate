...
'''
Configuration for Command Execution Profile for Event Rule resource
'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				command_execution_profile_obj= command_execution_profile()
				return cls.perform_operation_bulk_request(service,resource,command_execution_profile_obj)
		except Exception as e :
			raise e
