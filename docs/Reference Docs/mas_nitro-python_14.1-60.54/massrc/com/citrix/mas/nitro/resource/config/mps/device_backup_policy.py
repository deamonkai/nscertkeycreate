...
class device_backup_policy(base_resource):
	...
	_enable_geodb_backups= ""
	_backup_times= ""
	_sdx_backup_timeout= ""
	_number_of_backups= ""
	_enable_scheduled_backups= ""
	_enable_external_transfer= ""
	_backup_on_cfg_sav_trap= ""
	_backup_ontrap_delay= ""
	__count=""
	'''
	get the resource id
	'''
	...
	'''
	get Parameter to decide whether backup setting is interval based or time based
	'''
	@property
	def is_interval_based(self) :
		try:
			return self._is_interval_based
		except Exception as e :
			raise e
	'''
	set Parameter to decide whether backup setting is interval based or time based
	'''
	@is_interval_based.setter
	def is_interval_based(self,is_interval_based):
		try :
			if not isinstance(is_interval_based,bool):
				raise TypeError("is_interval_based must be set to bool value")
			self._is_interval_based = is_interval_based
		except Exception as e :
			raise e
	...
	'''
	get Enable GeoDB Backup from NetScaler (default is disabled)
	'''
	@property
	def enable_geodb_backups(self) :
		try:
			return self._enable_geodb_backups
		except Exception as e :
			raise e
	'''
	set Enable GeoDB Backup from NetScaler (default is disabled)
	'''
	@enable_geodb_backups.setter
	def enable_geodb_backups(self,enable_geodb_backups):
		try :
			if not isinstance(enable_geodb_backups,bool):
				raise TypeError("enable_geodb_backups must be set to bool value")
			self._enable_geodb_backups = enable_geodb_backups
		except Exception as e :
			raise e


	'''
	get Comma Separated string of backup times to be scheduled.
	'''
	@property
	def backup_times(self) :
		try:
			return self._backup_times
		except Exception as e :
			raise e
	'''
	set Comma Separated string of backup times to be scheduled.
	'''
	@backup_times.setter
	def backup_times(self,backup_times):
		try :
			if not isinstance(backup_times,str):
				raise TypeError("backup_times must be set to str value")
			self._backup_times = backup_times
		except Exception as e :
			raise e


	'''
	get Backup Timeout for SDX Backup
	'''
	@property
	def sdx_backup_timeout(self) :
		try:
			return self._sdx_backup_timeout
		except Exception as e :
			raise e
	'''
	set Backup Timeout for SDX Backup
	'''
	@sdx_backup_timeout.setter
	def sdx_backup_timeout(self,sdx_backup_timeout):
		try :
			if not isinstance(sdx_backup_timeout,int):
				raise TypeError("sdx_backup_timeout must be set to int value")
			self._sdx_backup_timeout = sdx_backup_timeout
		except Exception as e :
			raise e
	...
	'''
	get Enable Scheduled Backup (default is enabled)
	'''
	@property
	def enable_scheduled_backups(self) :
		try:
			return self._enable_scheduled_backups
		except Exception as e :
			raise e
	'''
	set Enable Scheduled Backup (default is enabled)
	'''
	@enable_scheduled_backups.setter
	def enable_scheduled_backups(self,enable_scheduled_backups):
		try :
			if not isinstance(enable_scheduled_backups,bool):
				raise TypeError("enable_scheduled_backups must be set to bool value")
			self._enable_scheduled_backups = enable_scheduled_backups
		except Exception as e :
			raise e


	'''
	get Enable transfer of device backup files to external server
	'''
	@property
	def enable_external_transfer(self) :
		try:
			...
			raise e
	'''
	set Enable transfer of device backup files to external server
	'''
	...
	'''
	get Backup on receiving NetscalerConfigSave trap
	'''
	@property
	def backup_on_cfg_sav_trap(self) :
		try:
			...
			raise e
	'''
	set Backup on receiving NetscalerConfigSave trap
	'''
	...
	'''
	get Delay in taking Backup on Receiving NetscalerConfigSave trap
	'''
	@property
	def backup_ontrap_delay(self) :
		try:
			return self._backup_ontrap_delay
		except Exception as e :
			raise e
	'''
	set Delay in taking Backup on Receiving NetscalerConfigSave trap
	'''
	@backup_ontrap_delay.setter
	def backup_ontrap_delay(self,backup_ontrap_delay):
		try :
			if not isinstance(backup_ontrap_delay,int):
				raise TypeError("backup_ontrap_delay must be set to int value")
			self._backup_ontrap_delay = backup_ontrap_delay
		except Exception as e :
			raise e
