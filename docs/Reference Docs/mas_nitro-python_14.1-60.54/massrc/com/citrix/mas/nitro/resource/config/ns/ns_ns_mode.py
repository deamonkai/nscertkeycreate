...
'''
Configuration for NetScaler Mode resource
'''
...
class ns_ns_mode(base_resource):
	...
	'''
	get List of NetScaler IP Addresses
	'''
	@property
	def ns_ip_address_arr(self) :
		try:
			...
			raise e
	'''
	set List of NetScaler IP Addresses
	'''
	...
	'''
	Use this operation to get ns mode for a given NetScaler IP Address.
	'''
	@classmethod
	def get(cls,client = None,resource="",option_=""): 
		try:
			...
			if not resource :
				...
				response = ns_ns_mode_obj.get_resources(client,option_)
			else:
