...
class domain(af_generic_api):
	_application_name= ""
	_num_of_open_connections_breaches= ""
	_total_requests= ""
	_application_response_time= ""
	_ip_address= ""
	_num_of_hits_breaches= ""
	...
	_client_ip_address= ""
	_percent_bw_saved= ""
	_num_of_response_time_mcb= ""
	_num_of_bandwidth_breaches= ""
	_ic_reval= ""
	_num_of_response_time_breaches= ""
	_num_of_open_connections_mcb= ""
	_server_ip_address= ""
	_network_latency_client_side= ""
	_ic_no_store_reason= ""
	_network_latency_server_side= ""
	_miss_count_breaches= ""
	_ic_non_cache_hits= ""
	_ic_utilization= ""
	...
	def get_object_id(self) :
		try:
			return super(domain,self).get_object_id()
		except Exception as e :
			raise e
	...
	'''
	No of times the timewindow breaches for open connections to this domain in the sampled timeframe.
	'''
	@property
	def num_of_open_connections_breaches(self):
		try:
			return self._num_of_open_connections_breaches
		except Exception as e :
			raise e
	'''
	No of times the timewindow breaches for open connections to this domain in the sampled timeframe.
	'''
	@num_of_open_connections_breaches.setter
	def num_of_open_connections_breaches(self,num_of_open_connections_breaches):
		try :
			if not isinstance(num_of_open_connections_breaches,float):
				raise TypeError("num_of_open_connections_breaches must be set to float value")
			self._num_of_open_connections_breaches = num_of_open_connections_breaches
		except Exception as e :
			raise e

	'''
	Total requests to this Domain in given sampled timeframe.
	'''
	@property
	...
	'''
	No of times the timewindow breaches for hits to this domain in the sampled timeframe.
	'''
	@property
	def num_of_hits_breaches(self):
		try:
			return self._num_of_hits_breaches
		except Exception as e :
			raise e
	'''
	No of times the timewindow breaches for hits to this domain in the sampled timeframe.
	'''
	@num_of_hits_breaches.setter
	def num_of_hits_breaches(self,num_of_hits_breaches):
		try :
			if not isinstance(num_of_hits_breaches,float):
				raise TypeError("num_of_hits_breaches must be set to float value")
			self._num_of_hits_breaches = num_of_hits_breaches
		except Exception as e :
			raise e

	'''
	Cache Miss total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	Cache Bypass total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	Percentage of bw save to this Domain in given sampled timeframe.
	'''
	@property
	...
	'''
	No of missed count breaches for response time to this domain in the sampled timeframe.
	'''
	@property
	def num_of_response_time_mcb(self):
		try:
			return self._num_of_response_time_mcb
		except Exception as e :
			raise e
	'''
	No of missed count breaches for response time to this domain in the sampled timeframe.
	'''
	@num_of_response_time_mcb.setter
	def num_of_response_time_mcb(self,num_of_response_time_mcb):
		try :
			if not isinstance(num_of_response_time_mcb,float):
				raise TypeError("num_of_response_time_mcb must be set to float value")
			self._num_of_response_time_mcb = num_of_response_time_mcb
		except Exception as e :
			raise e

	'''
	No of times the timewindow breaches for bandwidth to this domain in the sampled timeframe.
	'''
	@property
	def num_of_bandwidth_breaches(self):
		try:
			return self._num_of_bandwidth_breaches
		except Exception as e :
			raise e
	'''
	No of times the timewindow breaches for bandwidth to this domain in the sampled timeframe.
	'''
	@num_of_bandwidth_breaches.setter
	def num_of_bandwidth_breaches(self,num_of_bandwidth_breaches):
		try :
			if not isinstance(num_of_bandwidth_breaches,float):
				raise TypeError("num_of_bandwidth_breaches must be set to float value")
			self._num_of_bandwidth_breaches = num_of_bandwidth_breaches
		except Exception as e :
			raise e

	'''
	Total requests to this domain for cache bypass in given sampled timeframe.
	'''
	@property
	def ic_reval(self):
		try:
	...
	'''
	No of times the timewindow breaches for response time to this domain in the sampled timeframe.
	'''
	@property
	def num_of_response_time_breaches(self):
		try:
			return self._num_of_response_time_breaches
		except Exception as e :
			raise e
	'''
	No of times the timewindow breaches for response time to this domain in the sampled timeframe.
	'''
	@num_of_response_time_breaches.setter
	def num_of_response_time_breaches(self,num_of_response_time_breaches):
		try :
			if not isinstance(num_of_response_time_breaches,float):
				raise TypeError("num_of_response_time_breaches must be set to float value")
			self._num_of_response_time_breaches = num_of_response_time_breaches
		except Exception as e :
			raise e

	'''
	No of missed count breaches for open connections to this domain in the sampled timeframe.
	'''
	@property
	def num_of_open_connections_mcb(self):
		try:
			return self._num_of_open_connections_mcb
		except Exception as e :
			raise e
	'''
	No of missed count breaches for open connections to this domain in the sampled timeframe.
	'''
	@num_of_open_connections_mcb.setter
	def num_of_open_connections_mcb(self,num_of_open_connections_mcb):
		try :
			if not isinstance(num_of_open_connections_mcb,float):
				raise TypeError("num_of_open_connections_mcb must be set to float value")
			self._num_of_open_connections_mcb = num_of_open_connections_mcb
		except Exception as e :
			raise e
	...
	'''
	No of times the timewindow breaches count exceeds the configured miss count breach threshold to this Domain
	'''
	@property
	def miss_count_breaches(self):
		try:
			return self._miss_count_breaches
		except Exception as e :
			raise e
	'''
	No of times the timewindow breaches count exceeds the configured miss count breach threshold to this Domain
	'''
	@miss_count_breaches.setter
	def miss_count_breaches(self,miss_count_breaches):
		try :
			if not isinstance(miss_count_breaches,float):
				raise TypeError("miss_count_breaches must be set to float value")
			self._miss_count_breaches = miss_count_breaches
		except Exception as e :
			raise e
	...
	'''
	Total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	No of missed count breaches for bandwidth to this domain in the sampled timeframe.
	'''
	@property
	def num_of_bandwidth_mcb(self):
		try:
			return self._num_of_bandwidth_mcb
		except Exception as e :
			raise e
	'''
	No of missed count breaches for bandwidth to this domain in the sampled timeframe.
	'''
	@num_of_bandwidth_mcb.setter
	def num_of_bandwidth_mcb(self,num_of_bandwidth_mcb):
		try :
			if not isinstance(num_of_bandwidth_mcb,float):
				raise TypeError("num_of_bandwidth_mcb must be set to float value")
			self._num_of_bandwidth_mcb = num_of_bandwidth_mcb
		except Exception as e :
			raise e

	'''
	Total requests to this Domain for cache miss in given sampled timeframe.
	'''
	@property
	def cache_miss(self):
		try:
	...
	'''
	Total requests to this domain for cache hits in given sampled timeframe.
	'''
	@property
	def ic_hits(self):
		try:
	...
	'''
	 bandwidth breach reported values to this domain in the sampled timeframe.
	'''
	@property
	def bandwidth_breach(self):
		try:
			return self._bandwidth_breach
		except Exception as e :
			raise e
	'''
	 bandwidth breach reported values to this domain in the sampled timeframe.
	'''
	@bandwidth_breach.setter
	def bandwidth_breach(self,bandwidth_breach):
		try :
			if not isinstance(bandwidth_breach,float):
				raise TypeError("bandwidth_breach must be set to float value")
			self._bandwidth_breach = bandwidth_breach
		except Exception as e :
			raise e
	...
	'''
	No of missed count breaches breaches for hits to this domain in the sampled timeframe.
	'''
	@property
	def num_of_hits_mcb(self):
		try:
			return self._num_of_hits_mcb
		except Exception as e :
			raise e
	'''
	No of missed count breaches breaches for hits to this domain in the sampled timeframe.
	'''
	@num_of_hits_mcb.setter
	def num_of_hits_mcb(self,num_of_hits_mcb):
		try :
			if not isinstance(num_of_hits_mcb,float):
				raise TypeError("num_of_hits_mcb must be set to float value")
			self._num_of_hits_mcb = num_of_hits_mcb
		except Exception as e :
			raise e
	...
	'''
	Cache Reval total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	Percentage_usage of this Domain in given sampled timeframe.
	'''
	@property
	def percentage_usage(self):
		try:
			return self._percentage_usage
		except Exception as e :
			raise e
	'''
	Percentage_usage of this Domain in given sampled timeframe.
	'''
	@percentage_usage.setter
	def percentage_usage(self,percentage_usage):
		try :
			if not isinstance(percentage_usage,float):
				raise TypeError("percentage_usage must be set to float value")
			self._percentage_usage = percentage_usage
		except Exception as e :
			raise e
	...
	'''
	Hits breach values reported to this domain in the sampled timeframe.
	'''
	@property
	def hits_breach(self):
		try:
			return self._hits_breach
		except Exception as e :
			raise e
	'''
	Hits breach values reported to this domain in the sampled timeframe.
	'''
	@hits_breach.setter
	def hits_breach(self,hits_breach):
		try :
			if not isinstance(hits_breach,float):
				raise TypeError("hits_breach must be set to float value")
			self._hits_breach = hits_breach
		except Exception as e :
			raise e
	...
	'''
	Response time reported breach value to this domain in the sampled timeframe.
	'''
	@property
	def response_time_breach(self):
		try:
			return self._response_time_breach
		except Exception as e :
			raise e
	'''
	Response time reported breach value to this domain in the sampled timeframe.
	'''
	@response_time_breach.setter
	def response_time_breach(self,response_time_breach):
		try :
			if not isinstance(response_time_breach,float):
				raise TypeError("response_time_breach must be set to float value")
			self._response_time_breach = response_time_breach
		except Exception as e :
			raise e
	...
	'''
	IC Cache Hits total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	Cache Hits total bytes accounted by this domain in sampled timeframe.
	'''
	@property
	...
	'''
	Open connection breache value reported to this domain in the sampled timeframe.
	'''
	@property
	def open_connections_breach(self):
		try:
			return self._open_connections_breach
		except Exception as e :
			raise e
	'''
	Open connection breache value reported to this domain in the sampled timeframe.
	'''
	@open_connections_breach.setter
	def open_connections_breach(self,open_connections_breach):
		try :
			if not isinstance(open_connections_breach,float):
				raise TypeError("open_connections_breach must be set to float value")
			self._open_connections_breach = open_connections_breach
		except Exception as e :
			raise e
	...
	'''
	@miss_count.setter
	def miss_count(self,miss_count):
		try :
			if not isinstance(miss_count,float):
				raise TypeError("miss_count must be set to float value")
			self._miss_count = miss_count
		except Exception as e :
			raise e

	'''
	Af Report for Top Domain by Request Count Managed by this AF Collector.
	'''
	@classmethod
	def get(cls,client = None,resource="",option_=""): 
		try:
			...
			if not resource :
				domain_obj=domain()
				response = domain_obj.get_resources(client,option_)
			else:
	...
	'''
	Use this API to fetch filtered set of domain resources.
	...
	def get_filtered(cls,service,filter_) :
		try:
			...
			return domain_obj.getfiltered(service, option_)
		except Exception as e :
			raise e

	'''
	* Use this API to count the domain resources configured on NetScaler SDX.
	'''
	@classmethod
	def count(cls,service) :
		try:
			...
			option_ = options()
			option_._count=True
			response = domain_obj.get_resources(service, option_)
			if response :
	...
	'''
	Use this API to count the filtered set of domain resources.
	filter string should be in JSON format.eg: "vm_state:DOWN,name:[a-z]+"
	'''
	@classmethod
	def count_filtered(cls,service,filter_):
		try:
			...
			option_._count=True
			option_._filter=filter_
			response = domain_obj.getfiltered(service, option_)
			if response :
				return response[0].__dict__['__count']
			return 0;
		except Exception as e :
	...
	def get_nitro_response(self,service ,response):
		try :
			result=service.payload_formatter.string_to_resource(domain_response, response, self.__class__.__name__)
	...
	def get_nitro_bulk_response(self,service ,response):
		try :
			result=service.payload_formatter.string_to_resource(domain_responses, response, "domain_response_array")
			if(result.errorcode != 0) :
				if (result.errorcode == 444) :
					service.clear_session(self)
				response = result.domain_response_array
				i=0
				error = [domain() for _ in range(len(response))]
				for obj in response :
			...
			response = result.domain_response_array
			i=0
			domain_objs = [domain() for _ in range(len(response))]
			for obj in response :
				for props in obj._domain:
					result = service.payload_formatter.string_to_bulk_resource(domain_response,self.__class__.__name__,props)
					domain_objs[i] = result.domain
					i=i+1
			return domain_objs
		except Exception as e :
			raise e
...
'''
class domain_response(base_response):
	def __init__(self,length=1) :
		self.domain= []
		self.errorcode = 0 
		self.message = "" 
		self.severity = "" 
		self.domain= [ domain() for _ in range(length)]
'''
Forms the proper response for bulk operation.
'''
class domain_responses(base_response):
	def __init__(self,length=1) :
		self.domain_response_array = []
		self.errorcode = 0 
		self.message = "" 
		self.domain_response_array = [ domain() for _ in range(length)]
