...
class rba_authscope_props(base_resource):
	...
	'''
	get RBA operator has to be given as true if regex has been given for individual entities for services,servicegroup,servers while creating or modifying group.
	'''
	@property
	def rbaoperator(self) :
		try:
			...
			raise e
	'''
	set RBA operator has to be given as true if regex has been given for individual entities for services,servicegroup,servers while creating or modifying group.
	'''
	@rbaoperator.setter
	...
	'''
	get comma separated ids or use ALL for everything
	'''
	@property
	def propvalue(self) :
		try:
			...
			raise e
	'''
	set comma separated ids or use ALL for everything
	'''
	@propvalue.setter
