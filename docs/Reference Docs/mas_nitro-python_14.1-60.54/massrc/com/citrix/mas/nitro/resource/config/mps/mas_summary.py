...
'''
Configuration for NetScaler Console Summary resource
'''

class mas_summary(base_resource):
	_blx_count= ""
	_ns_gslbservicegroup_count= ""
	_ns_count= ""
	_ns_service_count= ""
	_dc_count= ""
	_ns_vip_count= ""
	_swg_count= ""
	_ns_gslbservice_count= ""
	_application_count= ""
	_partition_count= ""
	...
	def blx_count(self):
		try:
			return self._blx_count
		except Exception as e :
			raise e

	'''
	GSLB ServiceGroup count
	'''
	@property
	def ns_gslbservicegroup_count(self):
		try:
			return self._ns_gslbservicegroup_count
		except Exception as e :
			raise e
	...
	'''
	@property
	def ns_gslbservice_count(self):
		try:
			return self._ns_gslbservice_count
		except Exception as e :
			raise e
	...
	'''
	Use this operation to get NetScaler Console summary.
	'''
	@classmethod
