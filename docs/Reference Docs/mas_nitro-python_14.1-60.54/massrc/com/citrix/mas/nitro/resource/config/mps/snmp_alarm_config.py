...
class snmp_alarm_config(base_resource):
	...
	'''
	get Level 2 alarm configuration is supported or not
	'''
	@property
	def level2_alarm_supported(self) :
		try:
			return self._level2_alarm_supported
		except Exception as e :
			raise e
	'''
	set Level 2 alarm configuration is supported or not
	'''
	@level2_alarm_supported.setter
	def level2_alarm_supported(self,level2_alarm_supported):
		try :
			if not isinstance(level2_alarm_supported,bool):
				raise TypeError("level2_alarm_supported must be set to bool value")
			self._level2_alarm_supported = level2_alarm_supported
		except Exception as e :
			raise e


	'''
	get Frequency of the alarm in minutes
	'''
	@property
	def time(self) :
		try:
			...
			raise e
	'''
	set Frequency of the alarm in minutes
	'''
	@time.setter
	def time(self,time):
		try :
	...
	'''
	get Threshold Value for the alarm for level 2
	'''
	@property
	def threshold_level_2(self) :
		try:
			return self._threshold_level_2
		except Exception as e :
			raise e
	'''
	set Threshold Value for the alarm for level 2
	'''
	@threshold_level_2.setter
	def threshold_level_2(self,threshold_level_2):
		try :
			if not isinstance(threshold_level_2,int):
				raise TypeError("threshold_level_2 must be set to int value")
			self._threshold_level_2 = threshold_level_2
		except Exception as e :
			raise e


	'''
	get Alarm severity for level 2. Supported values: Major, Minor, Warning, Informational 
	'''
	@property
	def severity_level_2(self) :
		try:
			return self._severity_level_2
		except Exception as e :
			raise e
	'''
	set Alarm severity for level 2. Supported values: Major, Minor, Warning, Informational 
	'''
	@severity_level_2.setter
	def severity_level_2(self,severity_level_2):
		try :
			if not isinstance(severity_level_2,str):
				raise TypeError("severity_level_2 must be set to str value")
			self._severity_level_2 = severity_level_2
		except Exception as e :
			raise e
