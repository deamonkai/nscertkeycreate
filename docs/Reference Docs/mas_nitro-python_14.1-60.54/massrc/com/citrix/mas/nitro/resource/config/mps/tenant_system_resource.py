...
class tenant_system_resource(base_resource):
	...
	'''
	get Maximum number of SSL cores
	'''
	@property
	def max_ssl_cards(self) :
		try:
			...
			raise e
	'''
	set Maximum number of SSL cores
	'''
	...
	'''
	get Available number of Asymmetric Crypto Units
	'''
	@property
	def max_acu(self) :
		try:
			return self._max_acu
		except Exception as e :
			raise e
	'''
	set Available number of Asymmetric Crypto Units
	'''
	@max_acu.setter
	def max_acu(self,max_acu):
		try :
			if not isinstance(max_acu,int):
				raise TypeError("max_acu must be set to int value")
	...
	'''
	@property
	def available_acu(self) :
		try:
			return self._available_acu
		except Exception as e :
			raise e
	...
	'''
	get Available number of instances
	'''
	@property
	def available_instances(self) :
		try:
			...
			raise e
	'''
	set Available number of instances
	'''
	...
	'''
	get Available number of Symmetric Crypto Units
	'''
	@property
	def max_scu(self) :
		try:
			return self._max_scu
		except Exception as e :
			raise e
	'''
	set Available number of Symmetric Crypto Units
	'''
	@max_scu.setter
	def max_scu(self,max_scu):
		try :
			if not isinstance(max_scu,int):
				raise TypeError("max_scu must be set to int value")
			self._max_scu = max_scu
		except Exception as e :
			raise e
	...
	'''
	@property
	def available_scu(self) :
		try:
			return self._available_scu
		except Exception as e :
			raise e
