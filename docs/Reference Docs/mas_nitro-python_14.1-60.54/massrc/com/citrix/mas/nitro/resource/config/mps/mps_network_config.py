...
'''
Configuration for NetScaler Console Network Configuration resource
'''
...
class mps_network_config(base_resource):
	...
	'''
	Use this operation to modify NetScaler Console network configuration.
	'''
	@classmethod
	...
	'''
	Use this operation to get NetScaler Console network configuration.
	'''
	@classmethod
