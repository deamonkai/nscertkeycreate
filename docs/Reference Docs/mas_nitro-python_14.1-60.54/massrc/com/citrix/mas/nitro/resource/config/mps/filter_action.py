...
class filter_action(base_resource):
	...
	'''
	get RepeatEmailNotificationThreshold - If enabled, send the mail repeatedly at the specified intervals untill the event is cleared
	'''
	@property
	def repeat_email_notification_threshold(self) :
		try:
			...
			raise e
	'''
	set RepeatEmailNotificationThreshold - If enabled, send the mail repeatedly at the specified intervals untill the event is cleared
	'''
	...
	'''
	get If specified, the particular event will be suppressed for this time
	'''
	@property
	def suppress_time(self) :
		try:
			...
			raise e
	'''
	set If specified, the particular event will be suppressed for this time
	'''
	...
	'''
	Attachment for the E-mail action
	'''
	@property
	def attachment(self):
		try:
	...
	def attachment(self,attachment):
		try :
			if not isinstance(attachment,str):
				raise TypeError("attachment must be set to str value")
	...
	def user_message(self,user_message):
		try :
			if not isinstance(user_message,str):
				raise TypeError("user_message must be set to str value")
