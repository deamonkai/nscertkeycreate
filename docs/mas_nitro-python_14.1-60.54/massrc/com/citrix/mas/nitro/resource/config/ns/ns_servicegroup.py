...
'''
Configuration for NetScaler Service Group resource
'''
...
class ns_servicegroup(base_resource):
	...
	'''
	get AppFlow is enabled at servicegroup of LBVServer
	'''
	@property
	def appflowlog(self) :
		try:
			...
			raise e
	'''
	set AppFlow is enabled at servicegroup of LBVServer
	'''
	@appflowlog.setter
	...
	'''
	get Service Group Member Protocol Type
	'''
	@property
	...
	'''
	Use this operation to poll the service group.
	'''
	@classmethod
