...
'''
Configuration for NetScaler Syslog Configure Task resource
'''
...
class ns_syslog_task(base_resource):
	...
	'''
	get Comma separated Options for scheduling Configuration Template
	'''
	@property
	def scheduleOptions(self) :
		try:
			...
			raise e
	'''
	set Comma separated Options for scheduling Configuration Template
	'''
	...
	'''
	get Comma separated times of the day(HH:MM) on which Configuration Template is scheduled
	'''
	@property
	def scheduleTimes(self) :
		try:
			...
			raise e
	'''
	set Comma separated times of the day(HH:MM) on which Configuration Template is scheduled
	'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				return cls.perform_operation_bulk_request(service,resource,ns_syslog_task_obj)
		except Exception as e :
			raise e
