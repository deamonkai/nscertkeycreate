...
class license_info(base_resource):
	...
	'''
	get Total license used by ADC/SDX
	'''
	@property
	def vpx_license_used(self) :
		try:
			return self._vpx_license_used
		except Exception as e :
			raise e
	...
	'''
	get Burst license available for this license
	'''
	@property
	def burst_license_available(self) :
		try:
			return self._burst_license_available
		except Exception as e :
			raise e
