...
'''
Configuration for NetScaler Filter Policy Configure Task resource
'''
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				return cls.perform_operation_bulk_request(service,resource,ns_filterpolicy_template_obj)
		except Exception as e :
			raise e
