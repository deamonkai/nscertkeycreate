	...
	def get(cls,client = None,resource="",option_=""): 
		try:
			...
			if not resource :
				...
				response = eventrule_config_command_obj.get_resources(client,option_)
			else:
