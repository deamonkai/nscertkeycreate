...
class web_detail_data_collection_config(base_resource):
	...
	'''
	get Maximum number of record to be maintained except at first level report.
	'''
	@property
	def max_second_level_number_of_record(self) :
		try:
			return self._max_second_level_number_of_record
		except Exception as e :
			raise e
	...
	'''
	get Maximum number of record to be maintained at first level report.
	'''
	@property
	def max_first_level_number_of_record(self) :
		try:
			return self._max_first_level_number_of_record
		except Exception as e :
			raise e
