...
from massrc.com.citrix.mas.nitro.resource.config.mps.authorized_application import authorized_application
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				authorized_scope_obj= authorized_scope()
				return cls.perform_operation_bulk_request(service,resource,authorized_scope_obj)
		except Exception as e :
			raise e
