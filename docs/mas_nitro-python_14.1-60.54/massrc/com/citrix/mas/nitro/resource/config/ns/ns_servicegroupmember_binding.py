...
class ns_servicegroupmember_binding(base_resource):
	...
	'''
	get Display Name for the binding
	'''
	@property
	...
	'''
	get Server IP address associated with this servicegroup
	'''
	@property
	def ip(self) :
		try:
			...
			raise e
	'''
	set Server IP address associated with this servicegroup
	'''
	@ip.setter
	def ip(self,ip):
		try :
	...
	'''
	get ServerName associated with this binding
	'''
	@property
	def servername(self) :
		try:
			...
			raise e
	'''
	set ServerName associated with this binding
	'''
	@servername.setter
	...
	'''
	Use this operation to poll the Service Member Group.
	'''
	@classmethod
