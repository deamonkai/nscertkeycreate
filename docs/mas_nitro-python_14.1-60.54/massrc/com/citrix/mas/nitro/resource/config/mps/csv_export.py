...
class csv_export(base_resource):
	...
	'''
	get GraphQL query variable for export
	'''
	@property
	def graphql_variable(self) :
		try:
			return self._graphql_variable
		except Exception as e :
			raise e
	'''
	set GraphQL query variable for export
	'''
	@graphql_variable.setter
	def graphql_variable(self,graphql_variable):
		try :
			if not isinstance(graphql_variable,str):
				raise TypeError("graphql_variable must be set to str value")
	...
	def graphql_query(self) :
		try:
			...
			raise e
	'''
	set GraphQL query for export
	'''
	@graphql_query.setter
	def graphql_query(self,graphql_query):
		try :
			if not isinstance(graphql_query,str):
				raise TypeError("graphql_query must be set to str value")
	...
	def pageno(self,pageno):
		try :
			if not isinstance(pageno,int):
				raise TypeError("pageno must be set to int value")
			self._pageno = pageno
		except Exception as e :
			raise e
	...
	def pagesize(self,pagesize):
		try :
			if not isinstance(pagesize,int):
				raise TypeError("pagesize must be set to int value")
	...
	'''
	get report_type 'active' in case active report
	'''
	@property
	def report_type(self) :
		try:
			...
			raise e
	'''
	set report_type 'active' in case active report
	'''
	@report_type.setter
	def report_type(self,report_type):
		try :
			if not isinstance(report_type,str):
				raise TypeError("report_type must be set to str value")
	...
	def add(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				...
				csv_export_obj= csv_export()
				return cls.perform_operation_bulk_request(service,resource,csv_export_obj)
		except Exception as e :
			raise e
