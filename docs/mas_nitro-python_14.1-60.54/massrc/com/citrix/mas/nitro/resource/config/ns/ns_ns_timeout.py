...
'''
Configuration for NetScaler Timeout on NetScaler resource
'''
...
class ns_ns_timeout(base_resource):
	...
	'''
	Use this operation to get timeout from NetScaler Instance.
	'''
	@classmethod
	def get(cls,client = None,resource="",option_=""): 
		try:
			...
			if not resource :
				...
				response = ns_ns_timeout_obj.get_resources(client,option_)
			else:
