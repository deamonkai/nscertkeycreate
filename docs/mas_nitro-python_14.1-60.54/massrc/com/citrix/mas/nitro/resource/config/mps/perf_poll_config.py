...
'''
Configuration for Perf Poll Config resource
'''
...
class perf_poll_config(base_resource):
	...
	'''
	get Id is system generated key for the perf poll setting
	'''
	@property
	def id(self) :
		try:
			...
			raise e
	'''
	set Id is system generated key for the perf poll setting
	'''
	@id.setter
	def id(self,id):
		try :
