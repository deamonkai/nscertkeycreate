...
class techsupport(base_resource):
	...
	'''
	get Technical support Mode, Possible values Appliance | XenServer | Management Service | Appliance_full | Instances
	'''
	@property
	def mode(self) :
		try:
			...
			raise e
	'''
	set Technical support Mode, Possible values Appliance | XenServer | Management Service | Appliance_full | Instances
	'''
	@mode.setter
	def mode(self,mode):
		try :
	...
	def ManagementServiceIncludingInstances(cls,service=None,resource=None):
		try:
			...
			if type(resource) is not list :
				res = resource.perform_operation(service,"ManagementServiceIncludingInstances")
				return res
		except Exception as e :
			raise e
	...
	def XenServer(cls,service=None,resource=None):
		try:
			...
			if resource is None :
				raise Exception("Resource Object Not Found")
			if type(resource) is not list :
				res = resource.perform_operation(service,"XenServer")
				return res
		except Exception as e :
			raise e
	...
	def ManagementServiceAndXen(cls,service=None,resource=None):
		try:
			...
			if resource is None :
				raise Exception("Resource Object Not Found")
			if type(resource) is not list :
				res = resource.perform_operation(service,"ManagementServiceAndXen")
				return res
		except Exception as e :
			raise e
	...
	def start(cls,service=None,resource=None):
		try:
			...
			if resource is None :
				raise Exception("Resource Object Not Found")
			if type(resource) is not list :
				res = resource.perform_operation(service,"start")
				return res
		except Exception as e :
			raise e
	...
	def ApplianceIncludingInstances(cls,service=None,resource=None):
		try:
			...
			if resource is None :
				raise Exception("Resource Object Not Found")
			if type(resource) is not list :
				res = resource.perform_operation(service,"ApplianceIncludingInstances")
				return res
		except Exception as e :
			raise e
	...
	def ManagementService(cls,service=None,resource=None):
		try:
			...
			if resource is None :
				raise Exception("Resource Object Not Found")
			if type(resource) is not list :
				res = resource.perform_operation(service,"ManagementService")
				return res
		except Exception as e :
			raise e
