...
class mps(base_resource):
	...
	_current_time= ""
	_cc_pop_name= ""
	_cc_enable_security_advisory= ""
	_new_with_cloudconnect= ""
	_cloud_customer_name= ""
	_cc_enable_service_now= ""
	_cc_manual_mode_selection_date= ""
	_cc_client_id= ""
	_enable_mastlmy= ""
	_cc_profile_skip= ""
	_cc_profile_id= ""
	...
	'''
	Returns cloud connect pop name.
	'''
	@property
	def cc_pop_name(self):
		try:
			return self._cc_pop_name
		except Exception as e :
			raise e
	'''
	Returns cloud connect pop name.
	'''
	@cc_pop_name.setter
	def cc_pop_name(self,cc_pop_name):
		try :
			if not isinstance(cc_pop_name,str):
				raise TypeError("cc_pop_name must be set to str value")
			self._cc_pop_name = cc_pop_name
		except Exception as e :
			raise e

	'''
	Return if security advisory is enabled.
	'''
	@property
	def cc_enable_security_advisory(self):
		try:
			return self._cc_enable_security_advisory
		except Exception as e :
			raise e
	'''
	Return if security advisory is enabled.
	'''
	@cc_enable_security_advisory.setter
	def cc_enable_security_advisory(self,cc_enable_security_advisory):
		try :
			if not isinstance(cc_enable_security_advisory,bool):
				raise TypeError("cc_enable_security_advisory must be set to bool value")
			self._cc_enable_security_advisory = cc_enable_security_advisory
		except Exception as e :
			raise e

	'''
	new with cloudconnect
	'''
	@property
	...
	new with cloudconnect
	'''
	@new_with_cloudconnect.setter
	def new_with_cloudconnect(self,new_with_cloudconnect):
		try :
			if not isinstance(new_with_cloudconnect,bool):
				raise TypeError("new_with_cloudconnect must be set to bool value")
			self._new_with_cloudconnect = new_with_cloudconnect
		except Exception as e :
			raise e
	...
	'''
	@property
	def cloud_customer_name(self):
		try:
			return self._cloud_customer_name
		except Exception as e :
			raise e
	'''
	cloud customer name
	'''
	@cloud_customer_name.setter
	def cloud_customer_name(self,cloud_customer_name):
		try :
			if not isinstance(cloud_customer_name,str):
				raise TypeError("cloud_customer_name must be set to str value")
			self._cloud_customer_name = cloud_customer_name
		except Exception as e :
			raise e

	'''
	cloud connector feature enabled
	'''
	@property
	def cc_enable_service_now(self):
		try:
			return self._cc_enable_service_now
		except Exception as e :
			raise e
	'''
	cloud connector feature enabled
	'''
	@cc_enable_service_now.setter
	def cc_enable_service_now(self,cc_enable_service_now):
		try :
			if not isinstance(cc_enable_service_now,bool):
				raise TypeError("cc_enable_service_now must be set to bool value")
			self._cc_enable_service_now = cc_enable_service_now
		except Exception as e :
			raise e

	'''
	Returns date when manual mode was enabled.
	'''
	@property
	def cc_manual_mode_selection_date(self):
		try:
			return self._cc_manual_mode_selection_date
		except Exception as e :
			raise e
	'''
	Returns date when manual mode was enabled.
	'''
	@cc_manual_mode_selection_date.setter
	def cc_manual_mode_selection_date(self,cc_manual_mode_selection_date):
		try :
			if not isinstance(cc_manual_mode_selection_date,long):
				raise TypeError("cc_manual_mode_selection_date must be set to long value")
			self._cc_manual_mode_selection_date = cc_manual_mode_selection_date
		except Exception as e :
			raise e
	...
	'''
	Cloud Connector telemetry enabled
	'''
	@property
	...
	Cloud Connector telemetry enabled
	'''
	@enable_mastlmy.setter
	def enable_mastlmy(self,enable_mastlmy):
		try :
			if not isinstance(enable_mastlmy,bool):
				raise TypeError("enable_mastlmy must be set to bool value")
			self._enable_mastlmy = enable_mastlmy
		except Exception as e :
			raise e
	...
	'''
	Returns telemetry mode of collection.
	'''
	@property
	def cc_telemetry_mode(self):
		try:
			return self._cc_telemetry_mode
		except Exception as e :
			raise e
	'''
	Returns telemetry mode of collection.
	'''
	@cc_telemetry_mode.setter
	def cc_telemetry_mode(self,cc_telemetry_mode):
		try :
			if not isinstance(cc_telemetry_mode,str):
				raise TypeError("cc_telemetry_mode must be set to str value")
			self._cc_telemetry_mode = cc_telemetry_mode
		except Exception as e :
			raise e
