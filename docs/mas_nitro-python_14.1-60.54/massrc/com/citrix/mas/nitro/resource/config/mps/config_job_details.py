...
class config_job_details(config_job):
	...
	'''
	get Family of Devices ns/sdx for which config template is defined.
	'''
	@property
	def device_family(self) :
		try:
			...
			raise e
	'''
	set Family of Devices ns/sdx for which config template is defined.
	'''
	...
	'''
	Config job details export output Filename
	'''
	@property
	def filename(self):
		try:
